...
const VideoCard = ({ type, offsetY, oriageScrollHeight }: { type: number, offsetY: number; oriageScrollHeight: number }) => {
      ...
      <Container>
        ...
        <Pressable onPress={() => {
          ...
          <View>
            ...
            <Heading marginBottom={2} >Como é ganhar de R$ 30.000 a R$ 40.000 por mês?</Heading>
            <Video
              ref={video}
              style={styles.video}
            ...
            />
              <Text marginTop={2}>Minha renda mensal é superior a 40.000 reais, às vezes 100.000 reais, às vezes 30.000 reais ou 40.000 reais. Muitas pessoas podem pensar que estou fingindo, mas isso não é nada para quem está realmente ganhando dinheiro.</Text>
            </Box>
          </View>
        </Pressable>
        <Box width='100%'>
